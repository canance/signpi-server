...
urlpatterns = [
    ...
    url(r'^create_configuration', views.create_configuration, name='create_configuration'),
    url(r'^edit_configuration/(?P<config>\d+)/$', views.edit_configuration, name='edit_configuration'),
